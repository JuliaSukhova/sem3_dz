...
class OperationHelper(BasePage):
    ...
    def test_contact_us(self):
        ...
        self.find_element(TestSearchLocators.LOCATOR_OUR_NAME_FIELD).send_keys("GB202311d63248")
        self.find_element(TestSearchLocators.LOCATOR_EMAIL_FIELD).send_keys("GB202311d63248@mail.ru")
